...
```{r forb model plot mcmc, fig.dim = c(7,8)}
mcmc_plot(forb_mod, type = "rank_overlay")
```

```{r forb model plot pp}
...
```{r fern model plot mcmc, fig.dim = c(7,8)}
mcmc_plot(fern_mod, type = "rank_overlay")
```

```{r fern model plot pp}
...
```{r grass model plot mcmc, fig.dim = c(7,8)}
mcmc_plot(grass_mod, type = "rank_overlay")
```

```{r grass model plot pp}
...
```{r wood model plot mcmc, fig.dim = c(7,8)}
mcmc_plot(wood_mod, type = "rank_overlay")
```

```{r wood model plot pp}
...
```{r rubus model plot mcmc, fig.dim = c(7,8)}
mcmc_plot(rubus_mod, type = "rank_overlay")
```

```{r rubus model plot pp}
